        ...
        <div className={styles.container}>
            ...
            <div className={styles.textContainer}>
                ...
                <div className={styles.content}>
                    ...
                    <p><span>Departure Time: </span>{transformDate(trip.departureTime)}</p>
                    <p><span>ETA: </span>{transformDate(trip.eta)}</p>
                    <p><span>Arraival Time: </span>{transformDate(trip.arrivalTime)}</p>
